...
app.use(
  cors({
    origin: ["http://localhost:5173","https://webnxior.com","https://webnxior-beb5d.web.app" ,"http://localhost:5174" , "https://fir-connection-71eee.web.app" , "https://www.webnxior.com" ],// ✅ allow your Vite frontend
    credentials: true,
  })
);
